...
// Code Here
let groceries = ['cheese', 'eggs', 'milk']
//////////////////STEP 2////////////////////
...
// check if the number is greater than or equal to 5, return the string 'That looks like a big trip' from the function. If the number of groceries is equal to one,
// return the string '1 item'.
// For numbers between 1 and 5, return the string 'NUMBER items' with number replacing the number of items
'That looks like a big trip' '1 item'
// Code Here
